...
export const GroupChat = () => {
    return (
        <div className='group-chat' /*style={{ transform: `translateY(${-0.5 * offsetY}px)` }}*/>
            <div class='group-chat-child' id='group-chat-header'><p>VoicePals</p>
                <input type="text" id="group-name" placeholder="Group Name"></input>
            </div>

            <div class='group-chat-child' id='invite-friends'><p>Invite Friends</p>
                ...
                <input type="text" id="group-name" placeholder="Phone Number"></input>
            </div>
            ...
            <div class='group-chat-child' id='create-group-button' >
                Create Group
            </div>
        </div >
    )
